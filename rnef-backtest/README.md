...
[This is the frontend]([url](https://rnef-informs.vercel.app)) (the visual website part) of the Rice Renewable Energy Fund analytics tool. It lets the fund team run **backtests** — simulations that test how different investing strategies would have performed in the past using the fund's real stock holdings.
...
The [website]([url](https://rnef-informs.vercel.app)) has four pages, accessible from the left sidebar:
